...
import { Forms, React, Select, Text, TextInput, useEffect, useState } from "@webpack/common";
...
function ExtraPluginsTab() {
    ...
    return (
        <SettingsTab title="Plugin Repo">
            <div style={{ background: "var(--background-secondary-alt)", borderRadius: "8px", padding: "12px", marginBottom: "16px" }}>

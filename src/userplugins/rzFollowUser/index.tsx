...
export default definePlugin({
    name: "rz FollowUser",
    description: "Adds follow and reverse follow options in the user context menu to always be in the same VC as them or pull them to your VC. Shortcuts: Ctrl+Shift+R (clear list), Ctrl+Shift+T (trigger pull) | Enhanced by 10 or rz30 or rz",
    authors: [Devs.rz30,],
    settings,

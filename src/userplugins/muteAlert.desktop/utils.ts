...
const Native = VencordNative.pluginHelpers.MuteAlert as PluginNative<typeof import("./native")>;
...
export function checkFileMime(hex: string) {
    if (hex.startsWith("4f676753")) {
        ...
        // 52494646 ?? ?? ?? ?? 57415645
        return "audio/wav";
    } else if ((hex.startsWith("fff") && (hex.startsWith("b", 3) || hex.startsWith("3", 3) || hex.startsWith("2", 3)))
